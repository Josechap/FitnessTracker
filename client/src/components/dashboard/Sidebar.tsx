...
import { BarChart3, Dumbbell, Utensils, Bed, Target, Brain, Settings, Zap } from 'lucide-react';
              ...
              <div className="glassmorphism p-4 rounded-xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 capitalize">{user.membershipType} Member</p>
                  </div>
