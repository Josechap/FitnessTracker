        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="glassmorphism px-4 py-2 rounded-xl flex items-center space-x-2">
            <div className={cn(
              ...
              readiness.status === 'excellent' ? 'bg-green-400' :
              readiness.status === 'good' ? 'bg-yellow-400' : 'bg-red-400'
            )} />
            <Badge 
              variant="secondary" 
              className={cn("text-sm font-medium", readiness.color)}
            >
          ...
          <Button 
            variant="ghost" 
            size="sm"
            className="glassmorphism p-3 relative"
          >
